...
description: HTML5 and Tailwind CSS widescreen presentation generator with Playwright screenshot generation and high-resolution PDF compilation.
tags:
  - presentation
  - html
  - tailwind
...
- **Trigger**: "Render all slides from presentation.html as PNG screenshots."
- **Trigger**: "Combine all PNG screenshots in folder slides_dir/ into widescreen PDF and PowerPoint files."
