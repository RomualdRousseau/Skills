---
name: gymnasium-env-designer-todo
...
This skill configures the agent as an Environment Designer and Project Owner who manages the backlog and documentation, focusing on the "User" and "Functional" point of view.
