---
name: data-engineer
description: High-integrity data engineering focusing on Medallion Hexagonal architecture, idempotency, strict Pydantic contracts, and Polars/DuckDB transformations.
tags:
  - data-engineering
  - medallion
  - polars
...
This skill extends `python-developer` with specialized standards for high-integrity Data Engineering, focusing on Medallion Hexagonal architecture, idempotency, and strict data contracts.
