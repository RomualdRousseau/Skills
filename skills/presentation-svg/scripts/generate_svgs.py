...
def main():
    ...
    print("=== Hand-Crafted Vector SVG Generator ===")
  ...
  <g id="header">
    ...
    s1_logo = (
        f'<image x="1560" y="960" width="288" height="60" href="data:image/png;base64,{logo_sign_blanc_b64}"/>'
        if logo_sign_blanc_b64
        else ""
    )
  ...
  <g id="footer">
    ...
    chapters = [
        {"num": 2, "sec": "SECTION 01", "lbl": "THE CORE CHALLENGE", "title": "The Code Assistant Dilemma"},
        {
            "num": 5,
            "sec": "SECTION 02",
            "lbl": "ORBIT: THE OPERATING MODEL",
            "title": "A Unified Model for AI-Native Data Factories",
        },
        {
            "num": 9,
            "sec": "SECTION 03",
            "lbl": "US-IT EXECUTION PLAYBOOK",
            "title": "Implementation Details &amp; Roadmaps",
        },
    ...
    for chap in chapters:
        ...
        logo_part = (
            f'<image x="1560" y="960" width="288" height="60" href="data:image/png;base64,{logo_sign_b64}"/>'
            if logo_sign_b64
            else ""
        )
  ...
  <g id="footer">
    ...
    s19_symbol = (
        f'<image x="824" y="404" width="272" height="272" href="data:image/png;base64,{symbole_blanc_b64}"/>'
        if symbole_blanc_b64
        else ""
    )
    ...
    content_slides = [
            ...
            "cols": [
                {
                    "x": 72,
                    "w": 856,
                    "title": "Hallucination &amp; Seniority Gap",
                    "icon": "trending-up",
                    "icon_color": "#ff5a24",
                    "lines": [
                ...
                },
                {
                    "x": 992,
                    "w": 856,
                    "title": "Fragmentation &amp; Security Risks",
                    "icon": "shield",
                    "icon_color": "#1d2366",
                    "lines": [
        ...
        # SLIDE 8
        {
            ...
            "cards": [
                ...
                {
                    "icon": "star",
                    "title": "Specialized US Skills",
                    "date": "LOCAL US INNOVATION",
                    "date_color": "#4f46e5",
                    "dashed": True,
                    "lines": [
        ...
        # SLIDE 10
        {
            ...
            "cards": [
                ...
                {
                    "icon": "cpu",
                    "title": "Lightweight Open Source",
                    "date": "LLAMA 3 / LOCAL MODEL",
                    "date_color": "#ff5a24",
                    "lines": [
        ...
        # SLIDE 11
        {
            ...
            "cards": [
                ...
                {
                    "icon": "check-circle",
                    "title": "Gating &amp; Pre-Commit",
                    "date": "03. VERIFICATION",
                    "date_color": "#4f46e5",
                    "dashed": True,
                    "lines": [
        ...
        # SLIDE 16
        {
            ...
            "cards": [
                {
                    "icon": "plus",
                    "title": "1. Skill Creation",
                    "date": "LOCAL WORKSPACE",
                    "date_color": "#1d2366",
                    "lines": [
        ...
        # SLIDE 18
        {
            ...
            "cards": [
                {
                    "icon": "users",
                    "title": "1. Joint Bootcamps",
                    "date": "TALENT ACCELERATION",
                    "date_color": "#1d2366",
                    "lines": [
                ...
                {
                    "icon": "heart",
                    "title": "2. Pair Programming",
                    "date": "CO-DEVELOP AUTOMATIONS",
                    "date_color": "#ff5a24",
                    "lines": [
                ...
                {
                    "icon": "award",
                    "title": "3. Active Contribution",
                    "date": "GLOBAL ACKNOWLEDGEMENT",
                    "date_color": "#4f46e5",
                    "dashed": True,
                    "lines": [
