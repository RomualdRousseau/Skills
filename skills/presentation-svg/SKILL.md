...
description: Vector SVG presentation generator producing high-fidelity standalone slides, PowerPoint PPTX decks, and PDF exports.
tags:
  - presentation
  - svg
  - pptx
...
- **Trigger**: "Generate SVG slides for [topic]"
- **Trigger**: "Compile the SVG slides into an editable PowerPoint"
- **Trigger**: "Render vector PDFs from my SVG slides"
- **Trigger**: "Convert slide SVGs into crisp PNG screenshots"
