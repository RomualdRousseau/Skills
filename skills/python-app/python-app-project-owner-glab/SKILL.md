---
name: python-app-project-owner-glab
...
- **Trigger**: "Create a user story in GitLab for [feature]"
- **Trigger**: "Manage the backlog using glab"
- **Trigger**: "Refine GitLab issues"
- **Trigger**: "List open tasks/stories from GitLab"
